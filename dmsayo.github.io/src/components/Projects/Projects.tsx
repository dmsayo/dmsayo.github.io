...
export const Projects = () => {
    return (
        <div className="projects" id="projects">
            ...
            <ProjectCard title="dmsayo.github.io" imageUrl={""} description="My personal website (here!). Written using React.js and Typescript. Click learn more to see the full source code." moreLink="https://github.com/dmsayo/dmsayo.github.io"/>
        </div>
    )
};